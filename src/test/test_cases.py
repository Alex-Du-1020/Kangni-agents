...
async def run_all_tests():
    ...
    for i, test_case in enumerate(test_cases, 1):
        # if(i not in [16]):  # Test both SQL and keyword validation
        #     continue
