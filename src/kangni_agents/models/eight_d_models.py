...
class CauseAnalysis(BaseModel):
    ...
    causeConfidence: Optional[int] = Field(None, description="原因置信度", alias="causeConfidence")
...
class D4RootCauseAnalysisRequest(BaseModel):
    ...
    faultKeyword: Optional[str] = Field(None, description="故障关键词，辅助聚焦问题", alias="faultKeyword")
